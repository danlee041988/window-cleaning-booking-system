...
export class EmailTemplateService {
   ...
   */
  mapFormDataToTemplateParamsSimple(formData) {
   ...
   */
  getSelectedCommercialServices(formData) {
    const services = [];
   ...
   */
  getSelectedGeneralEnquiryServices(formData) {
    const services = [];
   ...
   */
  getBookingOrEnquiryText(formData) {
